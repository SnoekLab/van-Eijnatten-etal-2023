...
genes <- c("tag-173","tub-1","C45G9.12")
...
# Extract legend for later use by plot_grid()
...
png("plots_new_perm/int_fdr_01_02.png",width = 3200,height = 1000)
...
pdf("pdfs_figures/Figure_S12.pdf",width = 40, height = 15)
plot_grid(legend,plot_grid(gene_1,gene_2,gene_3,nrow = 1,align = "h",labels = c("A","B","C"),label_size = 40,axis="rtbl"),nrow = 2,rel_heights = c(1,5))+
  theme(plot.margin = unit(c(20,20,20,20), "points"))
dev.off()
