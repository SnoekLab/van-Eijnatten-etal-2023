...
saveRDS(pval_gen_time_intlm, file = "~/Documents/elegans/map_with_mean_dev_expr/pval_gen_time_int_mean_dev_perm.RDS")
...
saveRDS(pval_dev_time_intlm, file = "~/Documents/elegans/map_with_mean_dev_expr/pval_dev_time_int_mean_dev_perm.RDS")
...
saveRDS(pval_int_time_intlm, file = "~/Documents/elegans/map_with_mean_dev_expr/pval_int_time_int_mean_dev_perm.RDS")
