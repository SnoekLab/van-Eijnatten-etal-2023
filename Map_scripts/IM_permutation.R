...
saveRDS(pval_gen_time_intlm, file = "~/Documents/elegans/pvals_and_effect_size/pval_gen_time_intlm_one_perm.RDS")
...
saveRDS(pval_dev_time_intlm, file = "~/Documents/elegans/pvals_and_effect_size/pval_dev_time_intlm_one_perm.RDS")
...
saveRDS(pval_int_time_intlm, file = "~/Documents/elegans/pvals_and_effect_size/pval_int_time_intlm_one_perm.RDS")
